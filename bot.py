...
from handlers import (
    start_cmd, help_cmd, setmessage_cmd, clearmessages_cmd, removemessage_cmd, messages_cmd,
...
async def post_init(application):
    ...
    logging.info(f"Database ready. Advertising scheduled every {interval} minutes.")
...
if __name__ == '__main__':
    ...
    application.add_handler(CommandHandler("clearmessages", clearmessages_cmd))
